...
const BidRequestSchema = new mongoose.Schema({
  ...
  pricingEstimate: {
    type: {
      ...
      managedService: {
        baseMonthlyFeeCents: { type: Number, default: 50000, min: 0 },
        includedInContractTotal: { type: Boolean, default: false },
        estimatedContractMonthlyCents: { type: Number, default: null, min: 0 },
      },
      ...
      inputs: {
        ...
        sizeBenchmarkPerVisitCents: Number,
        benchmarkPropertyType: String,
